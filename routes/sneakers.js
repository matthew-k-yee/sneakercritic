...
SneakersRouter.post('/', async (req, res) => {
...
SneakersRouter.get('/:sneaker_id', async (req, res) => {
...
SneakersRouter.put('/:sneaker_id', async (req, res) => {
...
SneakersRouter.delete('/:sneaker_id', async (req, res) => {
